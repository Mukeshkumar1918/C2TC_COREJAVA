...
public class PrimitiveDataTypesDemo {
	public static void main(String[] args) { 
		  ...
		  System.out.println("Min range of byte is" + 
		    byteMin+"Max range of byte is 
		"+byteMax); 
		   
		  //short - 2 bytes 
		  short shortMax = 32767; 
		  short shortMin = -32768; 
		  System.out.println("Minshort range of byte 
		is" + 
		    shortMin+"Maxshort range of byte is 
		"+shortMax); 
		...
		+ 
		    minInt+"Maxint range of byte is 
		"+maxInt); 
		...
		+ 
		    minLong+"Maxlong range of byte is 
		"+maxLong); 
